...
<head>
<meta charset="UTF-8">
<title>Admin : View All Notes</title>
<%@include file="allCss.jsp"%>
</head>
<body>
	<%@include file="nav.jsp"%>
	<br>
	<span style="color: red"><h4 style="margin-top: 5px"
	...
	<div class="container mt-5">
		...
		<table class="table table-bordered" id="example">
			...
			<tbody>
				...
				<td><a href="editStatus.jsp?id=<%=rs.getString("id")%>"
					class="btn btn-sm btn-danger"> Assign Status</a></td>
				<td><a href="deleteUser.jsp?id=<%=rs.getString("id")%>"
