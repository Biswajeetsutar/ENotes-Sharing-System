...
<head>
<meta charset="UTF-8">
<title>Admin : View Accepted Notes</title>
...
<body>
	...
	<div class="container mt-5">
		...
		<h4 class="text-center text-danger">View Accepted Notes</h4>
		<br>
			...
			<tbody>
				<%
					try {
						...
						ResultSet rs = st.executeQuery("select * from notes where status='accept'");
						int i = 0;
						while (rs.next()) {
							i++;
				%>
